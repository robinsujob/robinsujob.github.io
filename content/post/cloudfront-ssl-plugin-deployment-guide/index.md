...
image: /images/posts/cloudfront-ssl-v1/architecture.png
categories:
  - AWS
tags:
  - cloudfront
...
![部署架构图](/images/posts/cloudfront-ssl-v1/architecture.png)
...
![EC2 控制台启动实例](/images/posts/cloudfront-ssl-v1/ec2-create.jpg)
...
![AMI 与实例类型](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-2.jpg)

在"密钥对"处选择已有或者创建新的密钥对，用于您后续操作系统的运维。

*Select an existing key pair or create a new one for SSH access.*

![密钥对设置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-3.jpg)
...
![网络配置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-4.jpg)

请在底部展开"高级详细信息"部分：

*Expand the "Advanced details" section at the bottom:*

![高级详细信息](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-5.jpg)
...
![用户数据](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-6.jpg)
...
![选择 EC2 实例](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-10.jpg)
...
![复制公有 DNS](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-11.jpg)
...
![浏览器访问验证](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-12.jpg)
...
![CloudFront 创建分配](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-13.jpg)
...
![源服务器设置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-14.jpg)

在默认缓存行为中，您可保持默认设置：

*Keep the default cache behavior settings:*

![缓存行为设置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-15.jpg)
...
![备用域名设置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-16.jpg)
...
![ICP 备案绿色标记](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-17.jpg)
...
![Route53 创建记录](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-18.jpg)

填写对应的解析记录：

*Fill in the DNS record:*

![解析记录配置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-19.jpg)

完成域名解析更新后，打开浏览器访问 ICP 备案的域名：

*After DNS update, access your ICP-filed domain in the browser:*

![浏览器访问域名](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-20.jpg)
...
![安全组前缀列表配置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-21.jpg)
...
![CloudFormation 部署](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-22.jpg)
...
![堆栈参数配置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-23.jpg)
...
![确认部署信息](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-24.jpg)
...
![SNS 订阅邮件](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-25.jpg)

订阅成功后的提示：

*Successful subscription confirmation:*

![订阅成功](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-26.jpg)
...
![堆栈输出](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-27.jpg)
...
![SSL 证书邮件通知](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-28.jpg)
...
![CloudFront 编辑设置](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-29.jpg)
...
![选择 SSL 证书](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-30.jpg)
...
![HTTPS 访问验证](/images/posts/cloudfront-ssl-v1/cloudfront-ssl-31.jpg)
