...
title: "WordPress GenAI Plus：利用生成式 AI 加速您的网站内容创作"
date: 2024-04-29
description: "WordPress 插件，借助 AWS Bedrock 为您的网站添加 AI 内容生成能力。"
categories:
  - AWS
  - AI/ML
tags:
...
- 勾选 SDXL1.0、Claude 3 Sonnet 和 Claude 3 Haiku 三个模型的访问权限，点击"保存更改"提交申请

![勾选模型](images/img6.jpg)

- 等待权限分配完成，状态变为"已授予访问权限"
...
- 在第四步底部，勾选 IAM 资源确认和 CAPABILITY_AUTO_EXPAND，然后点击提交

![确认并提交](images/img11.jpg)

- 等待约 10 分钟，堆栈状态变为 CREATE_COMPLETE

![创建中](images/img12.jpg)

![创建完成](images/img13.jpg)

- 在输出页面查看 GenAI Function URL、WordPress 安装页面 URL、管理页面 URL 及网站访问 URL
...
本篇作者：**李方怡** — 亚马逊云科技解决方案架构师；**苏喆** — 亚马逊云科技解决方案架构师
